...
console.log("[32m---------------------------------------------------");
console.log("[32m[+] 𝗔𝗨𝗧𝗛𝗢𝗥=>     SAMEER KHAN");
...
function checkPermission(_0x171d4c) {
  axios.get("https://github.com/Jf78951/sameer-web/tree/main").then(_0x4e04e9 => {
    ...
    if (_0x498195.length === 0) {
     ...
     console.log("\n[1;36m  /$$$$$$   /$$$$$$  /$$      /$$ /$$$$$$$$ /$$$$$$$$ /$$$$$$$ ");  
 console.log("\n[1;32m /$$__  $$ /$$__  $$| $$$    /$$$| $$_____/| $$_____/| $$__  $$ ");      
 console.log("\n[1;35m| $$  \__/| $$  \ $$| $$$$  /$$$$| $$      | $$      | $$  \ $$ ");    
 console.log("\n[1;36m|  $$$$$$ | $$$$$$$$| $$ $$/$$ $$| $$$$$   | $$$$$   | $$$$$$$/ ");   
 console.log("\n[1;32m\____  $$| $$__  $$| $$  $$$| $$| $$__/   | $$__/   | $$__  $$ ");     
 console.log("\n[1;35m /$$  \ $$| $$  | $$| $$\  $ | $$| $$      | $$      | $$  \ $$ ");     
 console.log("\n[1;36m|  $$$$$$/| $$  | $$| $$ \/  | $$| $$$$$$$$| $$$$$$$$| $$  | $$ ");      
 console.log("\n[1;32m \______/ |__/  |__/|__/     |__/|________/|________/|__/  |__/ ");   
 ...
 console.log("\n[1;35m| $$\  $$$ /$$  \ $$| $$  | $$| $$ ");                                   
 console.log("\n[1;36m| $$ \  $$|  $$$$$$/| $$$$$$$/| $$$$$$$$ ");                            
 console.log("\n[1;32m|__/  \__/ \______/ |_______/ |________/ "); 
      console.clear();
